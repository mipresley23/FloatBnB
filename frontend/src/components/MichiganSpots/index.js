...
export default function MichiganSpots() {
  ...
  const michiganSpots = spots && spots.filter(spot => spot.marinaId === 1)
  ...
  console.log('michigan spots: ', spots)

  return(
    <>
      <div id="splash-main-content">
        <h2 id="main-title">Michigan Spots</h2>
        <div className='images-container'>
          {
            michiganSpots && michiganSpots.map(spot => (
