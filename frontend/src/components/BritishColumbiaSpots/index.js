...
export default function BritishColumbiaSpots() {
  ...
  const britishColumbiaSpots = spots && spots.filter(spot => spot.marinaId === 8)
  ...
  return(
    <>
      <div id="splash-main-content">
        <h2 id="main-title">British Columbia Spots</h2>
        <div className='images-container'>
          {
            britishColumbiaSpots && britishColumbiaSpots.map(spot => (
