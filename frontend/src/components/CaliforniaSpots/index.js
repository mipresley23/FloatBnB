...
export default function CaliforniaSpots() {
  ...
  const californiaSpots = spots && spots.filter(spot => spot.marinaId === 2)
  ...
  return(
    <>
      <div id="splash-main-content">
        <h2 id="main-title">California Spots</h2>
        <div className='images-container'>
          {
            californiaSpots && californiaSpots.map(spot => (
