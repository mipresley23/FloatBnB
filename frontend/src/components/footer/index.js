  ...
  return(
    <div id='footer-container'>
      <div className='footer'>
        <a className='tech-links' href='https://expressjs.com/'>
        ...
        <a className='tech-links' href='https://www.sequelize.org/'>
        ...
        <a className='tech-links' href='https://developer.mozilla.org/en-US/docs/Web/JavaScript'>
        ...
        <a className='tech-links' href='https://www.linkedin.com/in/michael-presley-96729b235/'>
