...
export default function OntarioSpots() {
  ...
  const ontarioSpots = spots && spots.filter(spot => spot.marinaId === 9 || spot.marinaId === 10)
  ...
  return(
    <>
      <div id="splash-main-content">
        <h2 id="main-title">Ontario Spots</h2>
        <div className='images-container'>
          {
            ontarioSpots && ontarioSpots.map(spot => (
